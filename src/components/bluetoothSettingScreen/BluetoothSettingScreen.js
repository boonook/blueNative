...
export default class BluetoothSettingScreen extends Component {
    constructor(){
        super()
    ...
    renderItem(item) {
        const color = item.connected ? 'orange' : '#fff';
        return (
    ...
    render() {
        ...
        const btnScanTitle = '扫描蓝牙 (' + (this.state.scanning ? 'on' : 'off') + ')';
        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={styles.container}>
                    ...
                    <View style={{margin: 10}}>
                        <Button title="搜索可连接设备" onPress={() => this.retrieveConnected() } />
                    </View>
